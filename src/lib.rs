...
pub fn print_charge_breakdown(map: HashMap<String, Vec<Charge>>, subtotal: f64) {
...
pub fn process_individual_charges(persons: &Vec<String>) -> (HashMap<String, Vec<Charge>>, f64) {
